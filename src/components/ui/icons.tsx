...
/** Отвёртка слева и чуть выше, ключ справа и чуть ниже — оба по диагонали */
const SCREWDRIVER_AT = "translate(-52,-22) translate(128,128) scale(0.62) translate(-128,-128)";
const WRENCH_AT = "translate(52,22) translate(128,128) scale(0.62) translate(-128,-128)";

/** Отвёртка и ключ — сборка и разборка мебели */
